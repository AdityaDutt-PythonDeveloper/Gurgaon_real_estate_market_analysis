...
You are provided with a dataset containing residential property listings across
multiple sectors of Gurgaon.
The dataset includes pricing, area, BHK configuration, property type, builder details,
